...
function Panel() {
  ...
  const presaleAddress = '0xE97eA839E28804Ea20Af660FA37e6fe202CbceA1';
  ...
  const handleClickTrustWallet = () => {
    if (window.ethereum) {
      ...
      window.location.href = "https://link.trustwallet.com/open_url?&url=https://www.rizzmonkey.xyz/"
    }
  ...
  const handleMetamask = () => {
    if (window.ethereum) {
      ...
      window.location.href = "https://metamask.app.link/dapp/https://www.rizzmonkey.xyz/"
    }
  }
